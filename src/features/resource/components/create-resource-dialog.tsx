...
import { CreateResourceInput, createRoesourceSchema } from '../validation/create-resource-validator';
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Input placeholder="Meeting" {...field} /></FormControl>
                  <FormMessage />
                </FormItem>
              )}
            />
             <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Input placeholder="this is a hotel.." {...field} /></FormControl>
                  <FormMessage />
                </FormItem>
              )}
            />
            <DialogFooter className="gap-2 sm:gap-3">
              <Button type="button" variant="outline" onClick={() => setOpen(false)} disabled={isPending}>Avbryt</Button>
              <Button type="submit" disabled={isPending}>{isPending ? "Creating" : "Create resource"}</Button>
            </DialogFooter>
          </form>
            </Form>
      </DialogContent>
